...
function obj_val_update(weights::Float64; current_best::Float64, prev_best::Float64, iteration::Int, iteration_time::Float64, decay::Float64, _...)
    new_weights =  weights + (1-decay) * iteration * (prev_best/current_best)/ (1 + (iteration_time/10))
    return new_weights
end
